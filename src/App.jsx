...
const ColorfulParticleBackground = () => {
  ...
  useEffect(() => {
    ...
    if (!canvas) return;
    {
      ...
      description: 'Custom WordPress development, headless WordPress (WP + React/Next), theme & plugin development, migrations and performance optimization.',
      gradient: 'from-[#0D3430] via-[#16A085] to-[#1ABC9C]',
      bgGradient: 'from-[#0D3430]/5 to-[#16A085]/5',
      borderColor: 'border-[#16A085]',
      features: ['Custom Themes', 'Plugin Development', 'Headless CMS', 'Migrations & Optimization'],
      detailedFeatures: [
        { icon: '🎨', title: 'Custom Themes', desc: 'Pixel-perfect, responsive theme development' },
        { icon: '🔌', title: 'Plugin Development', desc: 'Custom plugins to extend WordPress functionality' },
        { icon: '⚡', title: 'Performance', desc: 'Caching, image optimization, and CDN setup' },
        { icon: '🔒', title: 'Security', desc: 'Hardened WP installs and regular audits' },
        { icon: '🧭', title: 'Migrations', desc: 'Seamless migrations from other platforms' },
        { icon: '🔗', title: 'Headless', desc: 'WP + GraphQL/REST powering React/Next frontends' },
      ],
      techStack: ['WordPress', 'PHP', 'MySQL', 'WPGraphQL', 'React', 'Next.js'],
      pricing: [
        { name: 'Starter', price: '$499', period: 'one-time', features: ['Small site', 'Theme setup', 'Basic SEO'] },
        { name: 'Business', price: '$1999', period: 'one-time', popular: true, features: ['Custom theme', 'Plugin dev', 'Performance tuning'] },
        { name: 'Enterprise', price: 'Custom', period: '', features: ['Headless CMS', 'SLA', 'Dedicated infra'] },
      ],
      useCases: [
        { icon: '📰', title: 'Publishing', desc: 'High-traffic editorial sites' },
        { icon: '🏬', title: 'Corporate', desc: 'Marketing sites with CMS' },
        { icon: '🛍️', title: 'Commerce', desc: 'WooCommerce stores and headless commerce' },
      ],
    },
          ...
          >
            ...
            >
              ...
              <div className="text-left">
                ...
                <div className="text-sm">techforgeaisolution@gmail.com</div>
              </div>
            </motion.a>
          </motion.div>
